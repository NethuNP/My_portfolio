  ...
  return (
    <div className="max-w-[1200px] sm:h-[150px] p-12 flex justify-between items-center mx-auto">
      ...
      <div className="flex space-x-4">
        ...
        <a
          href="https://x.com/0_prabodha_0?t=cVeZ3BYtwGKArYO3VW7RVw&s=09"
          target="_blank"
          rel="noopener noreferrer"
        >
        ...
        <a
          href="https://www.instagram.com/nethmini.praboda.54?igsh=YWRwNWpiMDUzbXE4"
          target="_blank"
          rel="noopener noreferrer"
        >
          <FontAwesomeIcon
        ...
        <a
          href="https://www.linkedin.com/in/nethmini-prabodha-31819a310/"
          target="_blank"
          rel="noopener noreferrer"
        >
          <FontAwesomeIcon
